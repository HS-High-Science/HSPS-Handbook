...
The ECFR emergency coolant system (also known as the E-coolant system) is used to inject the emergency coolant solution into the ECFR and **rapidly reduce the reactivity**.  
